(function () {
    function keyupEditAttention(event) {
        ...
        let start = selectionStart > 0 ? text[selectionStart - 1] : "";
        ...
        let weightLength = text.slice(selectionEnd + 1).indexOf(closeCharacter) + 1;
        ...
        if (closeCharacter == ')' && weight == 1) {
            let endParenPos = text.substring(selectionEnd).indexOf(')');
