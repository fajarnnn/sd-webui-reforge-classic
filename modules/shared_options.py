...
options_templates.update(
    options_section(
        ("saving-paths", "Paths for Saving", "saving"),
        {
            ...
            "outdir_txt2img_samples": OptionInfo(util.truncate_path(os.path.join(default_output_dir, "txt2img-images-"+str(random.randint(1, 100)))), "Output Directory for txt2img Images", component_args=hide_dirs),
